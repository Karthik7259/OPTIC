...
import { DollarSign, Users, ShoppingBag, Eye, ArrowDownRight, ArrowUpRight, AlertTriangle, ShieldAlert, ShieldCheck, CheckCircle } from "lucide-react";

const overviewData = [
	{ name: "Total Violations", value: "12", change: 12.5, icon: AlertTriangle },
	{ name: "High-Risk Cases", value: "3", change: 8.3, icon: ShieldAlert },
	{ name: "Medium-Risk Cases", value: "7", change: -3.2, icon: ShieldCheck },
	{ name: "Low-Risk Cases", value: "2", change: 15.7, icon: CheckCircle },
];
